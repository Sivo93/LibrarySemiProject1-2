...
public class NBoardVO {
	...
	public NBoardVO(int seq, String title, String writer, String content, String regdate, int cnt) {
		this.seq = seq;
		this.title = title;
		this.writer = writer;
	...
	public String toString() {
		return "NBoardVO [seq=" + seq + ", title=" + title + ", writer=" + writer + ", content=" + content + ", regdate="
				+ regdate + ", cnt=" + cnt + "]";
	}
